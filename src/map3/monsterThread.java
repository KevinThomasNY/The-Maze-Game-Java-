	...
	public boolean exit=false;
		...
		public void run() {
			...
			while (true) {
				...
				if (map.m_currentx2_2 == Operations.m_startx3_1 && Operations .m_starty2_2== Operations.m_starty3_1) {
					map.tp[map.m_currentx2_2][Operations .m_starty2_2].change(5);
				}else {
					map.tp[map.m_currentx2_2][Operations .m_starty2_2].change(1);
				}
					map.m_currentx2_2+=map.x;
					map.tp[map.m_currentx2_2][Operations .m_starty2_2].change(4);

	

			
				
				if (map.m_currentx2_2 -Operations.m_startx2_2== 4) {

					map.x = -1;
			

				}
				if (map.m_currentx2_2 == Operations.m_startx2_2) {
				...
				if (map.m_currentx2_2 == map.m -1) {

					map.x = -1;

				}
				
				if (map.m_currentx2_2 == 1) {
				...
				if (Operations.m_startx2_3 == Operations.m_startx3_1 && map.m_currenty2_2== Operations.m_starty3_1) {
					map.tp[Operations.m_startx2_3][map.m_currenty2_2].change(5);
				}else {
					map.tp[Operations.m_startx2_3][map.m_currenty2_2].change(1);
				}
					map.m_currenty2_2+=map.y;
					map.tp[Operations.m_startx2_3][map.m_currenty2_2].change(4);
				
			
				
				if (map.m_currenty2_2 -Operations.m_starty2_3== 4) {

					map.y = -1;

				}
				if (map.m_currenty2_2 == Operations.m_starty2_3) {
				...
				if (map.m_currenty2_2 == map.n -1) {

					map.y= -1;

				}
				
				if (map.m_currenty2_2 == 1) {
